"""
Django settings for punto4 project.
...
SECRET_KEY = 'django-insecure-4$ig__8o+waapmwte9h@l&qru9=5)0^!i@e5l$x&p-zb_&ufs7'
...
WSGI_APPLICATION = 'punto4.wsgi.application'
